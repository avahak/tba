...
/**
     ...
     */
function pixelsToNDC(p, element) {
 ...
 */
function NDCToPixels(ndc, element) {
    const rect = element.getBoundingClientRect();
...
/**
     ...
     */
function NDCToWorld3(ndc, height, camera) {
...
function NDCToWorld2(ndc, height, camera) {
    let p = NDCToWorld3(ndc, height, camera);
    return new THREE.Vector2(p.x, p.y);
}
function world2ToNDC(p, height, camera) {
